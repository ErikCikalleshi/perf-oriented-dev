...
def main():
    ...
    benchmarks = [
        '/home/cb76/cb761222/perf-oriented-dev/small_samples/build/mmul',
    ]
    ...
    with open("/home/cb76/cb761222/perf-oriented-dev/sol/2/a/benchmark_results_exec.csv", "w", newline="") as csvfile:
